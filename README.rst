...
The entry point for the Java code is the main class `PingPongCodegenMain <src/main/java/examples/pingpong/codegen/PingPongCodegenMain.java#L46-L99>`_. Look at this class to see:
